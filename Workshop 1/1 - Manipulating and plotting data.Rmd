...
For this first section we are going to use the file called _metab-workshop1.csv_.
...
Read and explore the dataset 'neurons-workshop1.csv'. This contains the number of neurons showing expression of a certain protein in  5 different brain regions. During processing some of the brain sections were lost, before counting could be done.^[What type of missing data is this?]

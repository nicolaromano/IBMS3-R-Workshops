...
What is the difference between mean male and female forearm length in our dataset? 
...
You can see that the difference is `r round(diff)` mm.
...
A bootstrap sample, then, is a random sample from that combined population.
